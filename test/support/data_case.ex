...
defmodule OpenDevCoach.DataCase do
  @moduledoc """
  ...
  by setting `use OpenDevCoach.DataCase, async: true`, although
  ...
  setup do
    ...
    servers_to_allow = [OpenDevCoach.Servers.Session, OpenDevCoach.Scheduler]
